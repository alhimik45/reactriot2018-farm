      ...
      <div>
        <Row>
          <Col md={3}>
            ...
            <div style={{fontSize: '8pt'}}>Used icon packs <b>Business Collection, Pc components, Technology Elements and Crypto currency</b> made by <a href="https://www.flaticon.com/authors/smashicons" title="Smashicons">Smashicons</a> from <a href="https://www.flaticon.com/" title="Flaticon">www.flaticon.com</a></div>
            <div style={{fontSize: '8pt'}}>Pick and DollarSign icons from <a href="https://github.com/twitter/twemoji" title="Twemoji">Twemoji</a> licensed under <a href="https://creativecommons.org/licenses/by/4.0/" title="CC-BY 4.0">CC-BY 4.0</a></div>
          </Col>
          <Col md={8}>
            <h1>Welcome</h1>
